...
public class FileUtil {
	...
	public static final void createFile(String fileNameWithPath,boolean overwritten)throws Exception{
	...
	public static final void writeALine(String fileNameWithPath, String content,boolean isHTML )throws Exception{
