...
public class Statics {
	...
	public static final String[] WEAPON_NAME =new String[] {"手枪","步枪","冲锋枪","重枪","火球术","天马流星拳","厚背鬼头刀","RPG7","双联装舰炮","折凳","口水","大便","手枪"};
	public static final String[] ABV = new String[] {"冷笑着","奸笑着","毫无表情地","贱贱地","庄严地","痛哭着","喜悦地","愤怒地","风骚地","苏木地"};
	public static final String[] ACTION = new String[] {"发射","扔出","敲","刺出"};
	public static final String[] MISS=new String[] {"凭借灵活的身法","风骚地一扭","重组了全身的DNA","钻到下水道里","召唤了天使"};
	public static final String[] WTF = new String[] {"夭寿啦","卧槽","呐呢","WTF"};
	public static final String[] FATAL = new String[] {"那个地方","毫无保护的秃头","物理法则层面","存在的意义","分子级别"};
	public static final String[] KILLER=new String[] {"时间","身为弱者的悲哀","无聊的攀比心","空气污染","毫无意义的人生","蟑螂","宇宙的法则","房价","高等数学","爱情"};
